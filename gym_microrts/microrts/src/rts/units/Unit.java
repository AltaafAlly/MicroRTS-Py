    ...
    public List<UnitAction> getUnitActions(GameState s, int noneDuration) {
        ...
        if (playerType.canAttack) {
            if (playerType.attackRange == 1) {
                ...
                int sqrange = playerType.attackRange * playerType.attackRange;
                for (Unit u : pgs.getUnits()) {
        ...
        for (UnitType ut : playerType.produces) {
